  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          Positioned(
              right: 0, child: SvgPicture.asset('assets/svg/mask_group.svg')),
                      ...
                      children: [
                        Container(
                          ...
                          child: SvgPicture.asset(
                              'assets/svg/forgott_password.svg'),
                        ),
                        SizedBox(
                            height: MediaQuery.of(context).size.height * 0.06),
                        Text("We will send a mail to the email",
                            textAlign: TextAlign.center,
                            style:
                                TextStyle(color: Colors.grey, fontSize: 14.0)),
                        SizedBox(height: 2.0),
                        Text("address you registered to regain your",
                            textAlign: TextAlign.center,
                            style:
                                TextStyle(color: Colors.grey, fontSize: 14.0)),
                        SizedBox(height: 2.0),
